...
Пользовательский интерфейс должен выглядеть как привычный мессенджер:
- список чатов;
- личные диалоги;
- групповые чаты;
- контакты;
...
- для будущего приложения выбран WhatsApp/Telegram-like UX без отображения Matrix rooms пользователю.
...
- после стабильного теста начать проектирование собственного web/android клиента с UX обычных чатов, а не Matrix-комнат.
